...
const Navbar = () => {
  ...
  return (
    ...
    >
        ...
        <div className="w-full flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <button
              ...
              className="lg:hidden text-brand-heading hover:bg-zinc-100 rounded-full transition-colors"
            >
      ...
      {/* TABLET/MOBILE SEARCH BAR (Visible for < 1024px, specifically requested for 427px to 769px) */}
      <AnimatePresence>
        {isSearchOpen && (
          <motion.div
